...
//		 sp = getSharedPreferences("SPnew", MODE_PRIVATE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.item1:
            	SecondActivity.this.startActivity(new Intent(SecondActivity.this,AddIDandPassword.class));
            	finish();
                return true;
            case R.id.item2:
            	SecondActivity.this.startActivity(new Intent(SecondActivity.this,GesturePassActivity.class));//设置锁
                finish();
            	return true;
            default:
            	return false;
